...
| **Reaction (Like)** | **1x** | Baseline |
| **Click "see more"** | **0.5-1x** | Interest signal |
...
- Comment format: strong first sentence, line break, end with a question
...
- Time spent reading your post **significantly affects its score**
- Long-form posts and carousels benefit from extended dwell
- Even without interaction, **10+ seconds reading = positive signal**
...
- LinkedIn actively detects and **penalizes pods** since 2023-2024
- Algorithm identifies unnatural engagement patterns
- **Alternative:** build a genuine network of 10-20 peers who naturally engage
- Authentic mutual engagement is sustainable; formal pods are risky
