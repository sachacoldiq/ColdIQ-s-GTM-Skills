...
|---|---|---|---|
| Writing a first cold email | **first-touch** | "write a cold email", "email 1", "first touch", "outbound template" | Read `cold-email/.claude/skills/first-touch/SKILL.md` |
| Writing follow-up emails | **follow-up** | "follow-up", "email 2/3", "no response", "bump", "breakup email" | Read `cold-email/.claude/skills/follow-up/SKILL.md` |
| Re-engaging old/lost leads | **re-engagement** | "re-engage", "closed-lost", "win back", "they ghosted", "reactivate" | Read `cold-email/.claude/skills/re-engagement/SKILL.md` |
| Subject line writing/testing | **subject-lines** | "subject line", "open rate", "A/B test subject" | Read `cold-email/.claude/skills/subject-lines/SKILL.md` |
...
- **Tool comparison, multi-channel setup, Clay integration** --> Read `cold-email/resources/examples/sequencing-tools.md`
...
--> Check if CTO is strategic (VP-level) or technical (IC-level). If strategic → route to **atl-messaging**. If technical/hands-on → route to **btl-messaging**. Read `cold-email/resources/frameworks/atl-btl-messaging.md`.
...
--> Route to **re-engagement**. Read `cold-email/resources/templates/email-templates-library.md`. Draft no-oriented question with new angle.

**Example 6: "What subject line should I use?"**
--> Route to **subject-lines**. Read `cold-email/resources/frameworks/writing-frameworks.md`. Provide 3-5 options with A/B test recommendation.
