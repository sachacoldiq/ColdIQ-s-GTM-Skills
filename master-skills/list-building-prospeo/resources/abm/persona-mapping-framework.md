...
---
## Persona Enrichment with your enrichment workspace
### Custom Properties to Enrich

When building contact lists in your enrichment workspace, enrich beyond standard fields:

| Property | How to Enrich | Why |
|---|---|---|
| **Persona** (custom) | Map from title using workspace AI or rules | Enables persona-specific campaigns |
...
| **LinkedIn URL** | Prospeo | For LinkedIn outreach + audience matching |
| **Verified email** | Email waterfall in your enrichment workspace | For outreach sequences |
### Persona Assignment Rules

Create rules in your enrichment workspace to auto-assign personas:
...
When ZenABM/Fibbler pushes engagement data to your CRM, the campaign name is how you extract:
