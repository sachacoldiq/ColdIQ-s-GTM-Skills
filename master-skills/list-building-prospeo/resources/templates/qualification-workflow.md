...
## ColdIQ Tier System
### Company Tiers (Apply with workspace AI columns)
...
---
## Workspace AI Prompts for Tiering
...
### Step 2: ICP Scoring
Apply weighted scoring (above) using workspace AI columns or formula columns.
...
|--------|----------|----------|------|
| **Prospeo** | Search, enrichment, verified emails and mobiles | 300M+ contacts, 40+ filters | $ |

| **Prospeo Native** | Company/people discovery | Good | workspace credits |
| **Lima Data** | LinkedIn-powered prospecting | High for LinkedIn data | API credits |
| **Prospeo Lookalike** | Lookalike companies, 3 modes | Included |
