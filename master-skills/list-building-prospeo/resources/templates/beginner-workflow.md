...
- CRM sync
- Prospeo export
- your enrichment workspace's native "Find People"

**Note:** A dedicated database beats a generic workspace's built-in search on coverage and freshness
...
- One verifier you control, for the spot-check and for re-verifying lists older than 30 days

**Via API (recommended for catchalls):**
- Prospeo strips catch-alls and spam traps upstream, so fewer reach you at all
